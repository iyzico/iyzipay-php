...
class PeccoSample
{
    public function should_initialize_pecco()
    {
        ...
        # make request
        $peccoInitialize = \Iyzipay\Model\PeccoInitialize::create($request, Sample::options());
    ...
    public function should_auth_pecco_payment()
    {
        ...
        # make request
        $peccoPayment = \Iyzipay\Model\PeccoPayment::create($request, Sample::options());

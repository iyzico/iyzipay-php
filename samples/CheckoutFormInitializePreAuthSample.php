...
$sample = new CheckoutFormInitializePreAuthSample();
$sample->should_initialize_checkout_form();

class CheckoutFormInitializePreAuthSample
{
    public function should_initialize_checkout_form()
    {
        ...
        # make request
        $checkoutFormInitializePreAuth = \Iyzipay\Model\CheckoutFormInitializePreAuth::create($request, Sample::options());

        # print result
        print_r($checkoutFormInitializePreAuth);
    }
}
...
class IyziLinkSaveProductResourceMapper extends IyzipayResourceMapper
{
    ...
    public function mapIyziLinkSaveProductResource(IyziLinkSaveProductResource $create)
    {
        return $this->mapIyziLinkSaveProductResourceFrom($create, $this->jsonObject);
    }
}
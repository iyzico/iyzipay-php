...
class ConnectPaymentPreAuthMapperTest extends TestCase
{
    public function test_should_map_connect_payment_pre_auth()
    {
        ...
        $connectPaymentPreAuth = ConnectPaymentPreAuthMapper::create($json)->jsonDecode()->mapConnectPaymentPreAuth(new ConnectPaymentPreAuth());

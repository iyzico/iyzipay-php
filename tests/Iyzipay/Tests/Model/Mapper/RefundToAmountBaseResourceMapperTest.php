...
use Iyzipay\Model\Mapper\RefundToAmountBasedResourceMapper;
use Iyzipay\Model\RefundToAmountBased;
use Iyzipay\Model\Status;
use Iyzipay\Tests\TestCase;

class RefundToAmountBaseResourceMapperTest extends TestCase
{
    public function test_should_map_refund_resource()
    {
        $json = $this->retrieveJsonFile("refund_to_amount_base.json");

        $refund = RefundToAmountBasedResourceMapper::create($json)->jsonDecode()->mapRefundToAmountBasedResource(new RefundToAmountBased());

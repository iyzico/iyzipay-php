...
use Iyzipay\Model\Mapper\UCSInitializeResourceMapper;
use Iyzipay\Model\UCSInitializeResource;
use Iyzipay\Tests\TestCase;

class UCSInitializeResourceMapperTest extends TestCase
{
    public function test_should_map_ucs_init_resource_mapper()
    {
        $json = $this->retrieveJsonFile("ucs_response.json");
        $details = UCSInitializeResourceMapper::create($json)->jsonDecode()->mapUCSInitializeResource(new UCSInitializeResource());

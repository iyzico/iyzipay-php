...
use Iyzipay\Model\Mapper\Subscription\SubscriptionUpgradeResourceMapper;
use Iyzipay\Model\Subscription\SubscriptionUpgrade;
use Iyzipay\Tests\TestCase;

class SubscriptionUpgradeResourceMapperTest extends TestCase
{
    public function test_should_map_subscription_upgrade_resource_mapper()
    {
        $json = $this->retrieveJsonFile("subscription_details.json");
        $details = SubscriptionUpgradeResourceMapper::create($json)->jsonDecode()->mapSubscriptionUpgrade(new SubscriptionUpgrade());

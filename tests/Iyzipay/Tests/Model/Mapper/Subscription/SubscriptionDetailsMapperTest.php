...
class SubscriptionDetailsMapperTest extends TestCase
{
    public function test_should_map_subscription_details_mapper()
    {
        $json = $this->retrieveJsonFile("subscription_details.json");
        $details = SubscriptionDetailsMapper::create($json)->jsonDecode()->mapSubscriptionDetails(new SubscriptionDetails());

...
class RetrieveSubscriptionCheckoutFormMapperTest extends TestCase
{
    public function test_should_map_subscription_checkout_form_mapper()
    {
        $json = $this->retrieveJsonFile("subscription_details.json");
        $details = RetrieveSubscriptionCheckoutFormMapper::create($json)->jsonDecode()->mapRetrieveSubscriptionCheckoutForm(new RetrieveSubscriptionCheckoutForm());

...
class RetrieveListMapperTest extends TestCase
{
    public function test_should_map_subscription_product_list_mapper()
    {
        $json = $this->retrieveJsonFile("product_list.json");
        $products = RetrieveListMapper::create($json)->jsonDecode()->mapRetrieveList(new RetrieveList());
    ...
    public function test_should_map_subscription_pricing_plan_list_mapper()
    {
        $json = $this->retrieveJsonFile("pricing_plan_list.json");
        $pricingPlans = RetrieveListMapper::create($json)->jsonDecode()->mapRetrieveList(new RetrieveList());
    ...
    public function test_should_map_subscription_customer_list_mapper()
    {
        $json = $this->retrieveJsonFile("customer_list.json");
        $customers = RetrieveListMapper::create($json)->jsonDecode()->mapRetrieveList(new RetrieveList());
    ...
    public function test_should_map_subscription_search_list_mapper()
    {
        $json = $this->retrieveJsonFile("subscription_list.json");
        $subscriptions = RetrieveListMapper::create($json)->jsonDecode()->mapRetrieveList(new RetrieveList());

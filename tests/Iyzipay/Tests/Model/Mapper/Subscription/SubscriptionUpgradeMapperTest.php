...
class SubscriptionUpgradeMapperTest extends TestCase
{
    public function test_should_map_subscription_upgrade_mapper()
    {
        $json = $this->retrieveJsonFile("subscription_details.json");
        $details = SubscriptionUpgradeMapper::create($json)->jsonDecode()->mapSubscriptionUpgrade(new SubscriptionUpgrade());

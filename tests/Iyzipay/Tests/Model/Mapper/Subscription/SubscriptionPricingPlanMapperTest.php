...
class SubscriptionPricingPlanMapperTest extends TestCase
{
    public function test_should_map_subscription_pricing_plan_mapper()
    {
        $json = $this->retrieveJsonFile("subscription_pricing_plan.json");
        $pricingPlan = SubscriptionPricingPlanMapper::create($json)->jsonDecode()->mapSubscriptionPricingPlan(new SubscriptionPricingPlan());
    ...
    public function test_should_map_subscription_delete_pricing_plan_mapper()
    {
        $json = $this->retrieveJsonFile("subscription_items_actions.json");

        $delete = SubscriptionPricingPlanMapper::create($json)->jsonDecode()->mapSubscriptionPricingPlan(new SubscriptionPricingPlan());

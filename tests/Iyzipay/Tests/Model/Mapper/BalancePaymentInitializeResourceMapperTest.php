...
use Iyzipay\Model\Mapper\BalancePaymentInitializeResourceMapper;
use Iyzipay\Model\Status;
use Iyzipay\Tests\TestCase;

class BalancePaymentResourceMapperTest extends TestCase
{
    public function test_should_map_balance_payment_initialize_resource()
    {
        $json = $this->retrieveJsonFile("initialize-balance-payment.json");

        $balancePaymentInitialize = BalancePaymentInitializeResourceMapper::create($json)->jsonDecode()->mapBalancePaymentInitializeResource(new BalancePaymentInitializeResource());

...
class ApmResourceMapperTest extends TestCase
{
    public function test_should_map_apm_resource()
    {
        $json = $this->retrieveJsonFile("retrieve-apm.json");

        $apm = ApmResourceMapper::create($json)->jsonDecode()->mapApmResource(new ApmResource());

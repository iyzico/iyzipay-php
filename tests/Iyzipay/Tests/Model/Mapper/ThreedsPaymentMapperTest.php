...
class ThreedsPaymentMapperTest extends TestCase
{
    public function test_should_map_threeds_payment()
    {
        ...
        $this->assertEquals("SUCCESS", $threedsPayment->getPaymentStatus());
        ...
        $this->assertEquals(Currency::TL, $threedsPayment->getCurrency());
        $this->assertEquals("connector name", $threedsPayment->getConnectorName());

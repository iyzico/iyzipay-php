...
class ConnectPaymentAuthMapperTest extends TestCase
{
    public function test_should_map_connect_payment_auth()
    {
        ...
        $connectPaymentAuth = ConnectPaymentAuthMapper::create($json)->jsonDecode()->mapConnectPaymentAuth(new ConnectPaymentAuth());

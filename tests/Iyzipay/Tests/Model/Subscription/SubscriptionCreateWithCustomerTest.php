...
{
    public function test_should_create_subscription_with_existing_customer()
    {
        $this->expectHttpPost();
        $createWithCustomer = SubscriptionCreateWithCustomer::create(new SubscriptionCreateWithCustomerRequest(), $this->options);
        $this->verifyResource($createWithCustomer);
    }
}